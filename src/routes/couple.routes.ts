...
// Rejected-account popup "Continue": deletes the account. The ONLY route a
// rejected couple can reach — everything else 403s (see authenticate.ts).
router.post('/me/acknowledge-rejection', asyncHandler(acknowledgeRejection));
